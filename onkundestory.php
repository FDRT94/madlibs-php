...
<body>
    ...
    <section>
    <h2>Onkunde</h2>
    <p>Er zijn veel mensen die niet kunnen <?= $_POST['vaardigheid']?>. 
    Neem nou <?= $_POST['goedpersoon']?>.
    Zelfs met de hulp van een <?= $_POST['voorwerp']?> of zelfs <?= $_POST['getal']?> kan <?= $_POST['goedpersoon']?> niet <?= $_POST['vaardigheid']?>
